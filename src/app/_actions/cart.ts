...
// import type { cartItemSchema, deleteCartItemSchema, deleteCartItemsSchema } from '@/lib/validations/cart';
...
//         .where(
//             and(inArray(products.id, uniqueProductIds), storeId ? eq(products.storeId, storeId) : undefined)
//         )
//         .groupBy(products.id)
...
// export async function updateCartItemAction(input: z.infer<typeof cartItemSchema>) {
//     const cartId = cookies().get('cartId')?.value;
